...
# Transcript aware comparisons and splicing changes

There are a couple of ways which were applied to compare the data at
the individual mRNA level instead of genes (transcript).

Once these were complete, one task that may be performed would be to
apply suppa and/or rMats and look for splicing events of interest.
