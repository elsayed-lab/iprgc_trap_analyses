...
for (k in seq_along(genotype_keepers)) {
  ...
  if (num_rows >= 10) {
    ...
    genotype_strict_cp[[name]] <- all_cprofiler(genotype_strict_sig[[name]], genotype_strict_tables[[name]],
...
for (k in seq_along(location_keepers)) {
  ...
  if (num_rows > 10) {
    ...
    location_strict_cp[[name]] <- all_cprofiler(location_strict_sig[[name]], location_strict_tables[[name]],
                                                orgdb = "org.Mm.eg.db", go_level = go_level,
                                                orgdb_from = orgdb_from,
                                                max_groupsize = max_groupsize, organism = "mouse")
...
for (k in seq_along(time_keepers)) {
  ...
  if (num_rows > 10) {
    ...
    time_cp[[name]] <- all_cprofiler(time_sig[[name]], time_tables[[name]],
                                     ...
                                     orgdb_from = orgdb_from,
                                     go_level = go_level, max_groupsize = max_groupsize)
...
for (k in seq_along(time_keepers)) {
  ...
  if (num_rows >= 10) {
    ...
    time_strict_cp[[name]] <- all_cprofiler(time_strict_sig[[name]], time_strict_tables[[name]],
                                            orgdb = "org.Mm.eg.db", go_level = go_level,
                                            orgdb_from = orgdb_from,
                                            max_groupsize = max_groupsize, organism = "mouse")
    #if (!is.null(get0("m2_gsc"))) {
