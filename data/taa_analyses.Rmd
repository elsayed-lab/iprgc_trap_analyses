---
title: "Analyses of the IPRGC re-processed samples: Matching my understanding to Theresa's."
...
query <- list("up" = test_table_up[["mgisymbol"]],
              "down" = test_table_down[["mgisymbol"]])
query_upset <- UpSetR::fromList(query)
UpSetR::upset(query_upset)
## ok, good.
```
...
cor.test(test_df[["limma_logfc"]], test_df[["ko_vs_het_logfc"]])
cor.test(test_df[["edger_logfc"]], test_df[["ko_vs_het_logfc"]])
tt <- plot_linear_scatter(test_df[, c("limma_logfc", "ko_vs_het_logfc")])
tt[["scatter"]]
tt <- plot_linear_scatter(test_df[, c("edger_adjp", "ko_vs_het_p")])
tt[["scatter"]]
